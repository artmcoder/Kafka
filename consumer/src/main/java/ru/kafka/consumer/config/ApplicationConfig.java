...
import ru.kafka.consumer.service.StringValueConsumer;
import ru.kafka.consumer.service.StringValueConsumerLogger;
...
public class ApplicationConfig {
    ...
    public ConsumerFactory<String, StringValue> consumerFactory(
        ...
        props.put(TYPE_MAPPINGS, "ru.kafka.producer.model.StringValue:ru.kafka.consumer.model.StringValue");
